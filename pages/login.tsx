                ...
                >
                    ...
                    <Space direction="vertical" size={30}>
                        <Space direction="vertical" size={15}>
                            <Input label="Email" placeholder="Enter your email" formSetting={formSetting} name={"email"} type="text" icon={<UserOutlined style={{ color: "gray" }} />} />
                            <Input label="Password" placeholder="Enter your password" formSetting={formSetting} name={"password"} type="password" icon={<UnlockOutlined style={{ color: "gray" }} />} />
                            <Select label="Role" placeholder="Enter your role" formSetting={formSetting} name={"role"} />
                        </Space>
